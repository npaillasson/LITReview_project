...
from .views import index, new_ticket, subscription_page, DeleteSubscription, new_follow, posts, EditTicket, DeleteTicket, CreationReview, DeleteReview, EditReview
